import React from "react"
        ...
        export default function pageName({ pageContext }) {
            ...
            pageContext.layout = {
                ...
                langToggleUrl: "/eng/about-us/our-experts/isabelle-tremblay"
...
<figure><img src="/images/our-experts/web_experts_ITremblay-sub.png" alt="" className="img-responsive" />
<figcaption>Isabelle Tremblay,<br/>
agente de programme</figcaption>
</figure>
</div>
<p>M<sup>me</sup> Tremblay s&rsquo;est jointe &agrave; la Commission canadienne de s&ucirc;ret&eacute; nucl&eacute;aire (CCSN) en 2009. En tant qu&rsquo;agente de programme, elle s&rsquo;emploie &agrave; r&eacute;glementer l&rsquo;utilisation des substances nucl&eacute;aires et &agrave; homologuer la s&ucirc;ret&eacute; de l&rsquo;&eacute;quipement r&eacute;glement&eacute; avant son utilisation au Canada. Elle doit s&rsquo;assurer que ces colis sont s&ucirc;rs et qu&rsquo;en cas d&rsquo;accident, les substances nucl&eacute;aires qu&rsquo;ils contiennent ne se disperseront pas dans l&rsquo;environnement.</p>
<h2>Expertise et &eacute;tudes</h2>
<p>M<sup>me</sup> Tremblay est titulaire d&rsquo;un baccalaur&eacute;at en g&eacute;nie m&eacute;canique de l&rsquo;Universit&eacute; McGill. Avant de se joindre &agrave; la CCSN, elle a travaill&eacute; dans le domaine de la micro&eacute;lectronique, o&ugrave; elle concevait et fabriquait des composants d&rsquo;infrastructure informatique et de r&eacute;seaux. Originaire de la r&eacute;gion du Saguenay, elle a pris la d&eacute;cision, au secondaire, de fr&eacute;quenter un pensionnat de langue anglaise situ&eacute; pr&egrave;s de la fronti&egrave;re canado-am&eacute;ricaine, s&rsquo;immergeant dans la langue afin de devenir bilingue.</p>
