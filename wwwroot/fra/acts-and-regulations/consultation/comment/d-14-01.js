...
<figure className="col-md-6">  <figcaption><strong>Figure 1:</strong> États de la centrale</figcaption>  <img src="/images/d-14-01/dis1401-fig1-fra.png"/>  </figure>
<p>L&#39;annexe&nbsp;A offre une description plus complète du tableau des états  de la centrale et présente les relations entre les états de la centrale et d&#39;autres  aspects de la conception, de l&#39;analyse et de l&#39;exploitation de la centrale  nucléaire.</p>  <div className="col-md-6 well ">
<p><strong>Question 1 :</strong> Les CAD ont-ils été caractérisés de façon claire et logique?</p>  </div>  <div className="col-md-6  text-right mrgn-bttm-0">
<p className="text-right"><a href="#wb-main"><span className="wb-icon-nav-090-alt"></span>Haut de la page</a></p>
</div>
</div>
<div className="col-md-6  mrgn-bttm-0">
...
<li>un  ensemble optimal de scénarios d&#39;accident en vue de le réduire à un nombre  gérable de séquences </li>  </ul>  <p>L&#39;attente qui sous-tend la détermination et la sélection des CAD est de  parvenir à éliminer, à&nbsp;toutes fins pratiques, les rejets importants dans l&#39;état  de la centrale concerné par la CAD. Pour&nbsp;une discussion plus approfondie  sur l&#39;identification des CAD, veuillez consulter l&#39;annexe C. </p>  <div className="col-md-6 well ">
<p> <strong>Question 2: </strong>Les éléments inclus en vue de l&#39;identification  des CAD sont-ils clairs, logiques, suffisants ou nécessaires?</p>  </div>  <div className="col-md-6  text-right mrgn-bttm-0">
<p className="text-right"><a href="#wb-main"><span className="wb-icon-nav-090-alt"></span>Haut de la page</a></p>
</div>
</div>
<div className="col-md-6  mrgn-bttm-0">
...
<li><strong>Par  télécopieur&nbsp;:</strong> 613-995-5086</li>  </ul>  <div className="col-md-6  text-right mrgn-bttm-0">
<p className="text-right"><a href="#wb-main"><span className="wb-icon-nav-090-alt"></span>Haut de la page</a></p>
</div>
</div>
<div className="col-md-6  mrgn-bttm-0">
...
<li>ASN, <a href="http://www.french-nuclear-safety.fr/content/download/85429/594504/version/1/file/technical_guidelines_design_construction.pdf"><em>Directives techniques pour la conception et la construction de la  prochaine génération de réacteurs nucléaires à eau sous pression</em></a>, adoptées  lors des séances plénières des experts allemands du GPR tenues les 19 et  26&nbsp;octobre 2000 (veuillez noter que cette page Web se télécharge  automatiquement) </li>  </ol>  <div className="col-md-6  text-right mrgn-bttm-0">
<p className="text-right"><a href="#wb-main"><span className="wb-icon-nav-090-alt"></span>Haut de la page</a></p>
</div>
</div>
<div className="col-md-6  mrgn-bttm-0">
...
</dl>  <div className="col-md-6  text-right mrgn-bttm-0">
<p className="text-right"><a href="#wb-main"><span className="wb-icon-nav-090-alt"></span>Haut de la page</a></p>
</div>
</div>
<div className="col-md-6  mrgn-bttm-0">
...
<li>CCSN, <a href="http://www.nuclearsafety.gc.ca/pubs_catalogue/uploads_fre/RD-360_f_PDF.pdf">RD-360,<em><u> Prolongement de la durée de vie des centrales nucléaires</u></em></a>, 2008</li>  </ol>  <div className="col-md-6  text-right mrgn-bttm-0">
<p className="text-right"><a href="#wb-main"><span className="wb-icon-nav-090-alt"></span>Haut de la page</a></p>
</div>
