...
<div className="col-md-2 module  pull-right mrgn-lft-0 mrgn-bttm-0 mrgn-bttm-xl" style="border:3px solid #006400;" >  <h3 className="text-center">Autres sources de renseignements</h3>
<ul>
...
<div className="col-md-2 module  pull-right mrgn-lft-0 mrgn-bttm-xl" style="border:3px solid #006400;">  <h4 className="text-center">La nouvelle normalité</h4>
<ul>
...
<div className="col-md-6 module ">  <p>Pour la section « Retour à la nouvelle normalité », la CCSN souhaite recueillir des commentaires sur la question suivante :</p>  <p>Q8. Le concept de nouvelle normalité est-il bien expliqué? Quels autres renseignements devrait-on fournir afin de clarifier ce concept?</p>  </div>
</div>
<div className="col-md-4  mrgn-tp-0 mrgn-bttm-0">
</div>
<div className="col-md-2  text-right mrgn-tp-0 mrgn-bttm-0">
...
<div className="col-md-6 module ">  <p>Pour la sous-section « Voies dexposition et évaluations de doses », la CCSN souhaite recueillir des commentaires sur la question suivante :</p>  <p>Q13. Nos hypothèses à légard des voies dexposition et des évaluations de doses sont-elles correctes? Dans la négative, quavons-nous oublié?</p>  </div>
...
<div className="col-md-6 module ">   <p>Pour la sous-section « Surveillance de la santé », la CCSN souhaite recueillir des commentaires sur la question suivante :</p>  <p>Q14. Avons-nous déterminé tous les éléments nécessaires du programme de surveillance de la santé? Dans la négative, quavons-nous oublié?</p>  </div>
</div>
<div className="col-md-4  mrgn-tp-0 mrgn-bttm-0">
</div>
<div className="col-md-2  text-right mrgn-tp-0 mrgn-bttm-0">
...
<div className="col-md-6 module ">  <p>Pour la sous-section « Gestion de la contamination », la CCSN souhaite recueillir des commentaires sur les questions suivantes :</p>  <p>Q15. Nos hypothèses à légard de la décontamination sont-elles correctes? Dans la négative, quavons nous oublié?</p>  <p>Q16. Avons-nous bien tenu compte des éléments de la décontamination? Dans la négative, quelles modifications ou quels ajouts proposez-vous?</p>  <p>Q17. Existe-t-il dautres types dactivités de nettoyage, outre la décontamination, dont il faudrait discuter de manière plus approfondie? Dans laffirmative, de quelles activités sagit-il? Quels renseignements sont nécessaires?</p>  </div>
...
<div className="col-md-6 module ">  <p>Pour la section « Protection des travailleurs responsables du rétablissement », la CCSN souhaite recueillir des commentaires sur les questions suivantes :</p>  <p>Q23. Quels autres renseignements à ce sujet devraient être inclus dans le cadre?</p>  </div>
</div>
<div className="col-md-4  mrgn-tp-0 mrgn-bttm-0">
</div>
<div className="col-md-2  text-right mrgn-tp-0 mrgn-bttm-0">
...
<div className="span-3 module pull-right mrgn-rght-0 mrgn-lft-0 mrgn-bttm-0 mrgn-tp-lg backgound-white" style="border:3px solid #006400;">  <h3 className="text-center">Diffusion dinformation</h3>  <p>Saviez-vous que la CCSN a pour <a href="/fra/the-commission/index#R1">mandat</a> dinformer objectivement le public sur les plans scientifique ou technique ou en ce qui concerne la réglementation?</p>  </div>
...
<div className="col-md-6 module ">  <p>Pour les sections « Références » et « Bibliographie », la CCSN souhaite recueillir des commentaires sur les questions suivantes :</p>  <p>Q26. Avons-nous oublié une source dinformation importante? Dans laffirmative, veuillez fournir les renseignements bibliographiques complets.</p>  <p>Q27. Avons-nous pris en compte tous les documents appropriés? Dans la négative, veuillez fournir la ou les sources de renseignements dont il faudrait tenir compte.</p>  </div>
</div>
<div className="col-md-4  mrgn-tp-0 mrgn-bttm-0">
</div>
<div className="col-md-2  text-right mrgn-tp-0 mrgn-bttm-0">
