...
<p>Tip: If you are asked to provide references, be sure to contact your references beforehand so they will be prepared to speak about your experience!</p>
...
<ul>
<li>Security: Effective July 2015, the Government of Canada requires all employees obtaining, renewing or upgrading a security clearance to be fingerprinted. Booking an appointment in a timely
manner will assist Security Services in expediting your clearance update (if required).</li>
<li>Official languages: If the position is bilingual, you may have to be tested if you have no valid second language evaluation (SLE) results, if your SLE results are expired, or if the position requires a higher level of proficiency. (Note: SLE results are valid for 5 years.)</li>
<li>Medical: Some positions require a medical examination due to the nature of the work and to ensure the safety of all workers. The HR assistant will provide you with details in order to schedule your appointment with a physician.</li>
</ul>
