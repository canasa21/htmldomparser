import React from "react"
        ...
        export default function pageName({ pageContext }) {
            ...
            pageContext.layout = {
                ...
                langToggleUrl: "/fra/about-us/careers-at-cnsc/index"
...
<p className="lead"><a href="https://youtu.be/d7MgPHB-tQw">We are the CNSC <img src="/images/we-are-cnsc-feature-eng.jpg" alt="" className="mrgn-tp-md"/></a></p>
<p>Video of CNSC employees serving Canadians by ensuring nuclear safety in Canada</p>
<p className="lead"><a href="https://youtu.be/2gxKY5bxzb4">Life at the CNSC <img src="/images/why-work-with-us-feature-eng.jpg" alt="" className="mrgn-tp-md"/></a></p>
