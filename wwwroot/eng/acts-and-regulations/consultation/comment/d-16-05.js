...
<li>continual effort to improve the organizational  system that governs, manages and guides human performance</li>  </ul>  <div className="alert alert-info col-md-12">
...
<h3>Q 4. Do you agree with the elements of a human performance program listed above? Are there items that you would add to or remove from the list above? Please explain.</h3>  </div>  <div className="alert alert-info col-md-12">
