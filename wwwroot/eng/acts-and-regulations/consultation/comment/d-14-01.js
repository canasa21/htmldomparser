...
The CNSC considers all feedback received from this consultation process in determining its regulatory approach.<strong> </strong></p>  <div className="clear"></div>
</div>
...
<li>an optimal set of accident scenarios to reduce it to a manageable number of sequences </li>  </ul>  <p>Underpinning identification and selection of DECs is the expectation that, in the DEC plant state, the practical elimination of significant releases is achieved. For a more in-depth discussion on the identification of DECs, please see Appendix C. </p>  <div className="col-md-12 well ">
<p> <strong>Question 2: </strong>Are the items included for the purposes of identifying DECs clear, logical, sufficient and/or required?</p>  </div>  <div className="col-md-12  text-right mrgn-bttm-0">
<p className="text-right"><a href="#wb-main"><span className="wb-icon-nav-090-alt"></span>Top of page</a></p>
</div>
<div className="clear"></div>
</div>
...
<li><strong>By fax:</strong> 613-995-5086</li>  </ul>  <div className="col-md-12  text-right mrgn-bttm-0">
<p className="text-right"><a href="#wb-main"><span className="wb-icon-nav-090-alt"></span>Top of page</a></p>
</div>
<div className="clear"></div>
</div>
...
<li><strong>Offsite response:</strong> Offsite response should not be needed for any event within the design basis, although it is acknowledged that precautionary measures may be taken if a release is considered possible should further failures occur. For increasing severity of events, emergency measures such as sheltering, administration of potassium iodine, short-term relocation or long-term evacuation may be implemented. </li>  </ul>  <div className="col-md-12  text-right mrgn-bttm-0">
<p className="text-right"><a href="#wb-main"><span className="wb-icon-nav-090-alt"></span>Top of page</a></p>
</div>
<div className="clear"></div>
</div>
...
<dt>USNRC</dt>
<dd>United States Nuclear Regulatory Commission</dd>  </dl>  <div className="col-md-12  text-right mrgn-bttm-0">
<p className="text-right"><a href="#wb-main"><span className="wb-icon-nav-090-alt"></span>Top of page</a></p>
</div>
<div className="clear"></div>
</div>
...
<li>CNSC <a href="http://www.nuclearsafety.gc.ca/pubs_catalogue/uploads/RD-360_e_PDF.pdf">RD-360,<em> Life Extension for Nuclear Power Plants</em></a>, 2008</li>  </ol>  <div className="col-md-12  text-right mrgn-bttm-0">
<p className="text-right"><a href="#wb-main"><span className="wb-icon-nav-090-alt"></span>Top of page</a></p>
</div>
