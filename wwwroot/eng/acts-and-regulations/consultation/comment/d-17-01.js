...
<div className="col-md-2 module  pull-right mrgn-lft-0 mrgn-bttm-0 mrgn-bttm-xl" style="border:3px solid #006400;" >  <h3 className="text-center">Additional sources of information</h3>
<ul>
...
<div className="col-md-6 module ">  <p>For this section on “Plans for recovery in Canada”, the CNSC would like to hear comments on the following questions:</p>  <p>Q3.	Did we correctly capture the existing framework for recovery from a federal, provincial and municipal point of view? If not, please provide information as you see it, accompanied by the source of information that supports your proposal.</p>  <p>Q4.	Are there existing documents or sources of information that provide more clarity?</p>  </div>
</div>
<div className="col-md-4  mrgn-tp-0 mrgn-bttm-0">
</div>
<div className="col-md-2  text-right mrgn-tp-0 mrgn-bttm-0">
...
</div>  <div className="col-md-2 module pull-right  mrgn-bttm-0 mrgn-lft-0 mrgn-bttm-xl" style="border:3px solid #006400;">  <h4 className="text-center">Optimization principle</h4>  <p>Optimization in recovery is a forward-looking, iterative process aimed at reducing future exposures. It takes into account technical and socio-economic factors. Optimization is a frame of mind, in which people must always question whether the best has been done in prevailing circumstances [15]. The recovery process is focused on the community. Every key decision must therefore be centred on stakeholder involvement.</p>  </div>
<ul>
...
<div className="col-md-2 module  pull-right mrgn-lft-0 mrgn-bttm-xl" style="border:3px solid #006400;">  <h4 className="text-center">The new normal</h4>
<ul>
...
<div className="col-md-6 module ">  <p>For this section on "Return to a new normal", the CNSC would like to hear comments on the following questions:</p>  <p>Q8.	Was the concept of the new normal well explained? What additional information should be provided to clarify the concept?</p>  </div>
</div>
<div className="col-md-4  mrgn-tp-0 mrgn-bttm-0">
</div>
<div className="col-md-2  text-right mrgn-tp-0 mrgn-bttm-0">
...
<div className="col-md-6 module ">  <p>For this subsection on "Exposure pathways and dose assessments", the CNSC would like to hear comments on the following questions:</p>  <p>Q13. Did we make the correct assumptions regarding exposure pathways and dose assessments? If not, what are we missing?</p>  </div>
...
<div className="col-md-6 module ">   <p>For this subsection on "Health monitoring", the CNSC would like to hear comments on the following questions:</p>  <p>Q14. Did we identify all the necessary components regarding the health monitoring program? If not, what are we missing?</p>  </div>
</div>
<div className="col-md-4  mrgn-tp-0 mrgn-bttm-0">
</div>
<div className="col-md-2  text-right mrgn-tp-0 mrgn-bttm-0">
...
<div className="col-md-6 module ">  <p>For this section on "Protecting recovery workers", the CNSC would like to hear comments on the following question:</p>  <p>Q23. What additional details would be valuable on this topic in the framework?</p>  </div>
</div>
<div className="col-md-4  mrgn-tp-0 mrgn-bttm-0">
</div>
<div className="col-md-2  text-right mrgn-tp-0 mrgn-bttm-0">
...
<div className="col-md-6 module ">  <p>For the reference and bibliography sections, the CNSC would like to hear comments on the following questions:</p>  <p>Q26. Have we missed a significant source of information? If yes, please provide the full bibliographical information.</p>  <p>Q27. Have we used or considered the appropriate documents and material? If not, please provide the relevant source of information to be considered.</p>  </div>
</div>
<div className="col-md-4  mrgn-tp-0 mrgn-bttm-0">
</div>
<div className="col-md-2  text-right mrgn-tp-0 mrgn-bttm-0">
