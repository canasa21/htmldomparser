...
<title><?php echo htmlspecialchars_decode($row["title"], ENT_QUOTES) ?></title>

<meta content="width=device-width,initial-scale=1" name="viewport">
<meta name="description" content="Web Experience Toolkit (WET) includes reusable components for building and maintaining innovative Web sites that are accessible, usable, and interoperable. These reusable components are open source software and free for use by departments and external Web communities">
<link rel="alternate" hreflang="fr" href="content-fr.html">
...
<a href="https://www.canada.ca/en.html" property="url"><img src="./themes-dist-GCWeb/GCWeb/assets/sig-blk-en.svg" alt="Government of Canada" property="logo"><span class="wb-inv"> / <span lang="fr">Gouvernement du Canada</span></span></a>
...
<li><a href="https://www.nuclearsafety.gc.ca/eng">Canadian Nuclear Safety Commission</a></li>
<?php echo htmlspecialchars_decode($row["breadcrumb"], ENT_QUOTES) ?>
</ol>
</div>
</nav>
</header>
<main property="mainContentOfPage" resource="#wb-main" class="container" typeof="WebPageElement">
<h1 property="name" id="wb-cont"><?php echo htmlspecialchars_decode($row["title"], ENT_QUOTES) ?></h1>
<p><strong>From <a href="#">Canadian Nuclear Safety Commission</a></strong></p>
<section>
<?php echo htmlspecialchars_decode($row["content"], ENT_QUOTES) ?>
</section>
...
<img src="./themes-dist-GCWeb/GCWeb/assets/wmms-blk.svg" alt="Symbol of the Government of Canada">
</div>
</div>
</div>
</div>
